...
public class CadenaCaracteres {
    ...
    public static void opcionesMenu() {
        ...
        do {
            System.out.println("---------------------MENU CADENA DE CARACTERES---------------------");
            System.out.println("1. Buscar la palabra '$Hyperboss'");//Indicar cuantas veces aparece en el texto
            System.out.println("2. Sustituir la palabra '$Hyperboss' por 'COÑAZO'");//Además tiene que aparecer en azul
            System.out.println("3. Primera frase en aparecer '$Hyperboss'");
            ...
            switch (opciones) {
                case 1:
                    ...
                    String buscar = "$Hyperboss";
                    int contador = 0;
                    //indexOf da -1 si la cadena de texto a buscar no exite y nos devuelve 1 si la encuentra
                    while (elCodigo.indexOf(buscar) > -1) {
                        elCodigo = elCodigo.substring(elCodigo.indexOf(buscar) + buscar.length());
                        contador++;
                    }
                    System.out.println("La palabra '$Hyperboss' aparece en el texto: " + contador);
                    break;
                case 2:
                    correcto = false;
